...
public class SellerFormController implements Initializable {
    ...
    private Seller getFormData() {
        ...
        object.setEmail(textFieldEmail.getText());
        ...
        if(datePickerBirthDate.getValue() == null){
            ...
            object.setBirthDate(Date.from(instant));
        }

        if(textFieldBaseSalary.getText() == null || textFieldBaseSalary.getText().trim().equals("")){
            exception.addError("baseSalary", "Field can't be empty");
        }
        object.setBaseSalary(Utils.tryParseToDouble(textFieldBaseSalary.getText()));

        object.setDepartment(comboBoxDepartment.getValue());
